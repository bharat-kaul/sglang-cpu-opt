# Roofline target vs measured — OLMo-2-7B (BF16)

**Node** `gnr_6980p (SINGLE SOCKET, TP=1, batch 8)` · **bf16** · **prefill (GEMM-bound)** · batch 8 · unit `TF/s`
...
|----|---------------|--------|-------------------|-------------------|------------|---------------|
| gate_up (MLP) | 30.0 | compute | 60.6 | 25.4 | 42% | 17.4 |
| down (MLP) | 30.0 | compute | 60.6 | 36.5 | 60% | 11.9 |
| qkv (attn) | 25.0 | compute | 60.6 | 35.4 | 58% | 10.4 |
| o (attn) | 15.0 | compute | 60.6 | 25.5 | 42% | 8.7 |

![roofline vs measured](./olmo2_7b_bf16_roofline.png)
